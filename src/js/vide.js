...
class Vide {
    ...
    set pip(input) {
        ...
        // Change icon
        const button = this.elements.buttons.pip
        if (toggle) {
            button.innerHTML = ''
            button.appendChild(
                controls.createIcon.call(this, 'pip-connected', {
            ...
            button.innerHTML = ''
            button.appendChild(
                controls.createIcon.call(this, 'pip', {
                    class: 'icon--not-pressed',
                })
            )
        }
    ...
    static setup(selector, options = {}) {
        ...
        return targets.map((t) => new Vide(t, options));
    }
}

Vide.defaults = cloneDeep(defaults);
