...
class Fullscreen {
    constructor(player) {
        ...
        on.call(this.player, this.player.elements.container, 'dblclick', (event) => {
            ...
            if (is.element(controls) && controls.contains(event.target)) {
                return
            }

            if (is.element(bottomControls) && bottomControls.contains(event.target)) {
                return
            }

            if (is.element(topControls) && topControls.contains(event.target)) {
                return
            }
